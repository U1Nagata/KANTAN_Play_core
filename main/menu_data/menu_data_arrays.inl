...
static constexpr menu_item_ptr menu_system[] = {
  ...
  MENU_BUILDER(mi_load_file_t         ,    4 , {   "Old"             , "旧データ"      }, def::app::data_type_t::data_song_preset_genre_old,      0 ),
  MENU_BUILDER(mi_load_file_t         ,   3  , {  "Song"             , "ソング"        }, def::app::data_type_t::data_song_preset_song, 0 ),
  MENU_BUILDER(mi_load_progression_t  ,   3  , {  "Sequence", "コード進行"    }, def::app::data_type_t::data_progression_preset ),
...
//MENU_BUILDER(mi_load_progression_t  ,   3  , {  "Sequence", "コード進行(SD)"    }, def::app::data_type_t::data_progression_users ),
  MENU_BUILDER(mi_save_t              ,  2   , { "Save"             , "保存"             }, def::app::data_type_t::data_song_users ),
  // MENU_BUILDER(mi_save_progression_t  ,   3  , { "Sequence", "コード進行(SD)"    }, def::app::data_type_t::data_progression_users ),
...
static constexpr menu_item_ptr menu_part[] = {
  ...
  MENU_BUILDER(mi_save_pattern_t , 1 , { "Save Pattern"   , "パターンの保存"  }, def::app::data_type_t::data_pattern_users),
...
//MENU_BUILDER(mi_load_progression_t,   3, {   "Sequence" , "コード進行(SD)"    }, def::app::data_type_t::data_progression_users ),
  MENU_BUILDER(mi_save_t            ,  2 , {  "Save"              , "保存"   }, def::app::data_type_t::data_song_users ),
//MENU_BUILDER(mi_save_progression_t,   3, {   "Sequence", "コード進行" }, def::app::data_type_t::data_progression_users ),
  MENU_BUILDER(mi_play_mode_t       ,  2 , {  "Play Mode"         , "プレイモード"      }),
  MENU_BUILDER(mi_recording_t       ,  2 , {  "Recoding"          , "レコーディング"     }),
  MENU_BUILDER(mi_reset_song_t      ,  2 , {  "Reset Song"        , "ソングデータリセット"}),
...
static constexpr menu_item_ptr menu_part_quick_edit[] = {
  ...
  MENU_BUILDER(mi_load_pattern_t   ,  2, {  "a. Drum"             , nullptr           }, def::app::data_type_t::data_pattern_drum ),
  MENU_BUILDER(mi_load_pattern_t   ,  2, {  "b. Bass"             , nullptr           }, def::app::data_type_t::data_pattern_bass ),
  MENU_BUILDER(mi_load_pattern_t   ,  2, {  "c. Guitar"           , nullptr           }, def::app::data_type_t::data_pattern_guitar ),
  MENU_BUILDER(mi_load_pattern_t   ,  2, {  "d. Piano"            , nullptr           }, def::app::data_type_t::data_pattern_piano ),
  MENU_BUILDER(mi_load_pattern_t   ,  2, {  "e. Other"            , nullptr           }, def::app::data_type_t::data_pattern_other ),
  MENU_BUILDER(mi_load_pattern_t   ,  2, {  "f. User(SD)"         , nullptr           }, def::app::data_type_t::data_pattern_users),
  MENU_BUILDER(mi_partvolume_t      , 1 , { "Volume"               , "音量"            }),
  MENU_BUILDER(mi_partpan_t         , 1 , { "Pan"                  , "左右バランス"     }),
  MENU_BUILDER(mi_anchor_set_t      , 1 , { "Chord Change Behavior", "コード変更時の動作"}),
  MENU_BUILDER(mi_pattern_edit_t   , 1 , { "Pattern Editor"       , "パターンエディター"}),
  MENU_BUILDER(mi_part_clipboard_t  , 1 , { "Copy/Paste"           , "コピー/ペースト"  }),
  MENU_BUILDER(mi_clear_notes_t     , 1 , { "Clear All Notes"      , "ノートをクリア"   }),
  nullptr, // end of menu
};
