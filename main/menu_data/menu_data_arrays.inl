...
static constexpr menu_item_ptr menu_system[] = {
  ...
  MENU_BUILDER(mi_tree_t              ,   3  , {   "Genre"           , "ジャンル"       }),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Simple"         , "シンプル"      }, def::app::data_type_t::data_song_preset_genre_simple,   0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Pop"            , "ポップス"      }, def::app::data_type_t::data_song_preset_genre_pop,      0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Rock"           , "ロック"        }, def::app::data_type_t::data_song_preset_genre_rock,     0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Dance"          , "ダンス"        }, def::app::data_type_t::data_song_preset_genre_dance,    0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Funk"           , "ファンク"      }, def::app::data_type_t::data_song_preset_genre_funk,     0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "R&B"            , "R&B"          }, def::app::data_type_t::data_song_preset_genre_rnb,      0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Jazz"           , "ジャズ"        }, def::app::data_type_t::data_song_preset_genre_jazz,     0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Latin"          , "ラテン"        }, def::app::data_type_t::data_song_preset_genre_latin,    0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Acoustic"       , "アコースティック"}, def::app::data_type_t::data_song_preset_genre_acoustic, 0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Ballad"         , "バラード"      }, def::app::data_type_t::data_song_preset_genre_ballad,   0 ),
  MENU_BUILDER(mi_load_file_t         ,    4 , {    "Specialty"      , "特殊リズム"    }, def::app::data_type_t::data_song_preset_genre_specialty,0 ),
