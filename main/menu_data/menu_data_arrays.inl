...
static constexpr menu_item_ptr menu_system[] = {
  ...
  MENU_BUILDER(mi_load_progression_t  , 1    , { "Sequence"         , "コード進行"    }, def::app::data_type_t::data_progression_preset ),
...
static constexpr menu_item_ptr menu_autosong[] = {
  ...
  MENU_BUILDER(mi_load_progression_t  ,  2   , {  "Sequence"        , "コード進行"  }, def::app::data_type_t::data_progression_preset ),
  MENU_BUILDER(mi_play_mode_t         ,  2   , {  "Play Mode"       , "プレイモード" }),
  MENU_BUILDER(mi_tree_t              ,  2   , {  "Edit"            , "編集"        }),
  MENU_BUILDER(mi_save_t              ,   3  , {   "Save"           , "保存"        }, def::app::data_type_t::data_song_users ),
